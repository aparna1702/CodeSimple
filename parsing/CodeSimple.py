...
KEYWORDS = ['namaste', 'dhanywaad', 'dekhao', 'jab tk', 'kram', 'agar', 'ya ye', 'ni tu', 'dashamlav', 'akshar',
            'karya', 'btao', 'suno', 'bus', 'chlterho', 'tbtk', 'badlo', 'mamla', 'theekh', 'sahiyagalat',
            'sahi', 'galat', 'barabar h', 'barabar_nhi_h', 'chotah', 'badah', 'ya', 'yebhi', 'jodo', 'ghatao',
            'guna', 'bhag', 'shesh', 'chotayabarabar', 'badayabarabar']
